        ...
        if ($this->ion_auth_model->forgotten_password($identity)) {
            ...
            if ($user) {
                ...
                if (!$this->config->item('use_ci_email', 'ion_auth')) {
                    ...
                    $this->email->subject($this->config->item('sender', 'ion_auth') . ' - ' . $this->lang->line('email_forgotten_password_subject'));
    ...
    public function register($identity, $password, $email, $additional_data = array(), $group_ids = array())
    {
        ...
        if (!$email_activation) {
            ...
            if (!$this->config->item('use_ci_email', 'ion_auth')) {
                ...
                $this->email->to($email);
                $this->email->subject($this->email_settings['sender'] . ' - ' . $this->lang->line('email_activation_subject'));
                $this->email->message($message);
