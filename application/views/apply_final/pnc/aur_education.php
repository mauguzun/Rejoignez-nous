...
<form method="post" action="<?= $url ?>"  v-on:submit.prevent="send">
	...
	<div class="card-body">
		...
		<div class="row row_mb">
			<div class="col-md-6">
				<div class="input_label"><span>*</span><?= lang('safety_training_certificate_date')?></div>
				<input type="search"
				name="safety_training_certificate_date"
				value="<?= $date ? $date['safety_training_certificate_date'] :  null ;?>"
				data-calendar="true"
				class="form-control" 
				required="required" 
				>
			...
			<div class="col-md-6">
				<div class="input_label"><span>*</span><?= lang('safety_training_certificate_organization')?></div>
				<input type="text"
				value="<?= $date ? $date['safety_training_certificate_organization'] :  null ;?>"
				name="safety_training_certificate_organization" class="form-control">
			</div>
		</div>
