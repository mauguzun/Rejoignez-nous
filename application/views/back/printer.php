...
<html>
    ...
    <body>
        ...
        <? $data   =
        [
            'application'=>[ 'category'=>'date', 'type'=>'type','activity'=>'activities' ],
            'profile'=>[
        ...
        <div class="container">
            ...
            <?
			$path = "https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=".base_url()."shared/zipofferuser/".$query['oid']."/".$query['uid']."";
