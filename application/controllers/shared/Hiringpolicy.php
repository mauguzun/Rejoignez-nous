...
class Hiringpolicy extends Shared_Controller
{
    ...
    */
    ...
    private function _set_form_validation($url)
    {
        ...
        $this->form_validation->set_rules('integration', lang('integration'), 'trim|required|max_length[10000]');
        $this->form_validation->set_rules('course', lang('course'), 'trim|required|max_length[10000]');
        $this->form_validation->set_rules('recruiting', lang('recruiting'), 'trim|required|max_length[10000]');
        $this->form_validation->set_rules('diversity', lang('diversity'), 'trim|required|max_length[10000]');
    ...
    private function _set_data($user = NULL)
    {
        ...
        foreach (['diversity','course','recruiting','integration',] as $column) {
