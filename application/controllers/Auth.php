...
class Auth extends CI_Controller
{
	...
	*/
	public function login()
	{
		...
		else
		{
			...
			$this->_render_page('front_asl' . DIRECTORY_SEPARATOR . 'login', $this->data);
		}
	}
	...
	*/
	public function forgot_password()
	{
		...
		if($this->form_validation->run() === FALSE)
		{
			...
			$this->data['message'] = (validation_errors()) ? validation_errors() : $this->session->flashdata('message');
			$this->_render_page('front_asl' . DIRECTORY_SEPARATOR . 'reset', $this->data);
		}
		else
		{
		...
		if($user)
		{
			...
			if($this->form_validation->run() === FALSE)
			{
				...
				$this->data['new_password_confirm'] = array(
					...
					'id'         => 'new_confirm',
					'required'   =>'require',
					'placeholder'=>sprintf(lang('reset_password_new_password_confirm_label'), $min_password_length),
					'class'      =>'form-control',
					'type'       => 'password',
					'pattern'    => '^.{' . $min_password_length . '}.*$',
				);
				...
				// render
				$this->_render_page('front_asl' . DIRECTORY_SEPARATOR . 'set_new_password', $this->data);
			}
			else
			{
	...
	public function create_user()
	{
		...
		else
		{
			...
			$this->data['password_confirm'] = array(
				...
				'class'      =>'form-control',
				'required'   =>'require',
				'placeholder'=> lang('create_user_password_confirm_label'),
				'type'       => 'password',
			...
			$this->data['privacy_pdf'] =  $this->get_privacy();

			// $this->_render_page('auth' . DIRECTORY_SEPARATOR . 'create_user', $this->data);

			$this->_render_page('front_asl' . DIRECTORY_SEPARATOR . 'register', $this->data);
		}
	}
	/**
	...
	*/
	public function redirectUser()
	{
		...
		if($this->ion_auth->in_group([1,2,3,4,5,6,7]))
		{
	...
	*/
	public function edit_user($id = null)
	{
		...
		*/
		...
		$this->show_header(['email_forgot_password_link']);
		$this->load->library("menu/Usermenu");
		$this->load->view(
			'front/parts/usermenu',
			[
				'page'=>'auth/edit_user',
				'user_menu'=>$this->usermenu->get()
			]
		);
		$this->load->view('front' . DIRECTORY_SEPARATOR . 'pass', $this->data);
		$this->show_footer();
