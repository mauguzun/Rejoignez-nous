...
class User extends Admin_Controller
{
	...
	public function index()
	{
		...
		$this->load->view('back/user_table_filter',[

				'groups'=>$this->Crud->get_all('groups')
		...
		if(isset($_GET) && isset($_GET['group'])){
			$url = $this->_redirect.'/ajax?group='.$_GET['group'];
		}	else
		{
	...
	public function ajax()
	{
		...
		$query = $this->Crud->get_joins_where_in(
			...
			['candidates.first_name','ASC'],null,'groups.id',$allowed);
